...
import { generate, Options as GeneratorOptions } from '@eagletrt/code-generator';

// NOTE: siccome voglio mantenere il modulo globale anche sui singoli pacchetti, conviene richiamarli come se fossero comandi da questa cli.
// Per farlo si può usare path.join(__dirname, '../node_modules/.bin', 'nome_bin')
// Anzi mi pare una merda anche così, bisognerebbe trovare un modo per mantenerli entrambi però
